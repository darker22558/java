<template>
  <div>
    <div style="padding: 10px">
      ...
      <el-button type="primary" @click="addHonor" class="el-icon-circle-plus-outline"> 新增</el-button>
      <el-button type="danger" @click="deleteHonorBatch" class="el-icon-remove-outline"> 批量删除</el-button>
    </div>
